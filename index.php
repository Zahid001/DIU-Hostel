...
<li><img src="data1/images/banner_01.jpg" alt="DIU University Campus" title="DIU University Campus" id="wows1_0"/></li>
...
<a href="#" title="DIU University Campus"><img src="data1/tooltips/banner_01.jpg" alt="DIU University Campus"/>1</a>
...
<span class="wsl"></span>
    ...
    <tr>
      <td height="38" colspan="2" style="background-color:pink">
	...
	?>
      ...
      <td width="343" style="background-color:#9400D3">
      <center><font size="+2"><b style="color:#191B7E"><div style="background-color:#969BFB">University Updates</div><br></b></font></center>
      	<marquee direction="up" height="100%" onMouseOver="stop()" onMouseOut="start()">
            ...
            <center><a href="index.php?option=admission" style="text-decoration:none"><font size="+1"><b>Admission 2018</b></font></a></center><br>
    ...
    <tr>
      <td height="25" colspan="2" style="background-color:#e9d8f2"><center><b>&copy; <?php echo $footerdisp['footerinfo']; ?></b></center>
